...
if (getWeb)
{
    absT14a <- "http://www.abs.gov.au/ausstats/meisubs.NSF/log?openagent&5368014a.xls&5368.0&Time%20Series%20Spreadsheet&64AA6910E6C3347CCA257B41000D8ED0&0&Feb%202013&03.04.2013&Latest"
...
xSub_sum12_melt <- melt(x2df(xSub_sum12), measure.vars = c(2:11))


gp_TradeDest <- ggplot(data = xSub_sum12_melt,
...
#
png(file.path(plotPATH, "tradeDest.png"))
grid.arrange(gp_TradeDest, sub = textGrob('www.ricardianambivalence.com'))
dev.off()
